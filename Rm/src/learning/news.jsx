...
export default function NewsPage() {
  ...
  const updatePost = async (content) => {
    ...
    try {
      ...
      await updateNews(editingPost.id, data);
      ...
      if (newFileAttachments.length) {
        try {
          const uploadResult = await uploadNewsFiles(editingPost.id, newFileAttachments.map(a => a.file));
  ...
  ">
                ...
                <div className="px-6 pt-6 pb-4 flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      {/* เมนูแก้ไข/ลบ "โพสต์" — คนละอันกับเมนูคอมเมนต์ */}
      ...
      "
                    ...
                    {/* ไฟล์แนบ (อัปโหลดจากเครื่อง / Google Drive) — รูปเลื่อนดูเป็นแถว กดเปิดเต็มจอเลื่อนดูทีละรูปได้ */}
                ...
                {/* Action bar: Like / Comment / Share — จัดชิดตรงกับตัวหนังสือชื่อผู้โพสต์ */}
